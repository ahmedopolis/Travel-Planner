...
2. [Instructions](#Instructions)
   ...
   24. [Add 'Babel-polyfill'](#Add-'Babel-polyfill')
   25. [Add 'supertest babel-cli superagent'](#Add-'supertest-babel-cli-superagent')
   26. [List of all needed npm commands](#List-of-all-needed-npm-commands)
